# Looking For Suspicious Transaction 
...
I will be doing ther followings:
...
Using database model as a blueprint, create a database schema for each of your tables and relationships.
